...
#import "WeexPublicFunction.h"
@interface WeexDatePickerView()<UIPickerViewDataSource,UIPickerViewDelegate>
{
...
@implementation WeexDatePickerView
...
-(void)createDatePickerView{
    ...
    for (int i=0; i<2; i++)
    {
        UIButton *cancelBtn = [WeexPublicFunction getButtonInControl:self frame:CGRectMake(10, 10, 80, 30) title:nil align:@"center" color:SetColor(@"#333333", 1) fontsize:16 tag:i+1 clickAction:@selector(btnClick:)];
        ...
        if (i==1)
        {
            ...
            UIButton *cancelBtn1 = [WeexPublicFunction getButtonInControl:self frame:CGRectMake(10, 5, 80, 30) title:nil align:@"center" color:SetColor(@"#333333", 1) fontsize:16 tag:i+1 clickAction:@selector(btnClick:)];
            //[cancelBtn setImage:[UIImage imageNamed:@"time_cancel"] forState:UIControlStateNormal];
...
//    UIButton *sureBtn = [WeexPublicFunction getButtonInControl:self frame:CGRectMake(MainS_Width- 100, cancelBtn.frame.origin.y, cancelBtn.bounds.size.width, cancelBtn.bounds.size.height) title:@"确定" align:@"center" color:SetColor(@"#333333", 1) fontsize:16 tag:2 clickAction:@selector(btnClick:)];
...
//    NSDictionary *dictionary=[[NSDictionary alloc]initWithContentsOfFile:path];
    ...
    for (int i=0; i<2; i++)
    {
        UIButton *cancelBtn = [WeexPublicFunction getButtonInControl:self frame:CGRectMake(10, 5, 80, 50) title:@"取消" align:@"center" color:SetColor(@"#333333", 1) fontsize:16 tag:i+1 clickAction:@selector(cancelBtnAndSureBtnClick:)];
