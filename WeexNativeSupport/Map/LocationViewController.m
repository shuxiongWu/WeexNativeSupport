...
#import "PublicTool.h"
@interface LocationViewController ()<AMapLocationManagerDelegate,AMapSearchDelegate,MAMapViewDelegate,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate>
...
- (void)addStartUpdatingLocation{
    ...
    [locationButton setImage:[PublicTool wx_imageNamed:@"location"] forState:UIControlStateNormal];
...
- (void)initSetting{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"CurrentLocationTableViewCell" bundle:resourceBundle] forCellReuseIdentifier:@"CurrentLocationTableViewCell"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    AddressModel *model = arr[indexPath.row];
