...
#import "WeexLocationHelper.h"
#import <UIKit/UIKit.h>
@implementation WeexLocationHelper

+ (WeexLocationHelper *) sharedGpsManager {
    static WeexLocationHelper *shared = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        shared = [[WeexLocationHelper alloc] init];
    });
    return shared;
}
...
+ (void) getMoLocationWithSuccess:(CMJFLocationSuccess)success Failure:(CMJFLocationFailed)failure {
    [[WeexLocationHelper sharedGpsManager] getMoLocationWithSuccess:success Failure:failure];
}
...
+ (void) stop {
    [[WeexLocationHelper sharedGpsManager] stop];
}
