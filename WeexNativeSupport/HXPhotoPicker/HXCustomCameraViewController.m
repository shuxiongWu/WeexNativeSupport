...
@interface HXCustomCameraViewController ()<HXCustomPreviewViewDelegate,HXCustomCameraBottomViewDelegate,HXCustomCameraControllerDelegate, CLLocationManagerDelegate,HXDatePhotoEditViewControllerDelegate>
...
- (void)changeTime:(NSInteger)time {
    if (time < 3) {
        ...
        self.timeLb.text = [NSString stringWithFormat:@"%lds",(long)time];
    }
