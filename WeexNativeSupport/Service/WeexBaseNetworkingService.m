...
@implementation WeexBaseNetworkingService

#pragma mark--post请求

static WeexBaseNetworkingService *manager;
+ (instancetype)shared {
           ...
           failure:(void (^)(NSURLSessionDataTask *operation, NSError *error))requestFailure
{
    ...
    AFHTTPSessionManager *manager = [WeexBaseNetworkingService shared];
     manager.responseSerializer = [AFHTTPResponseSerializer serializer];
    
    WeexNetworkHelper *helper = [WeexNetworkHelper shareHelper];
    NSString *network;
...
//        [WeexBaseNetworkingService deleteAllCookies];
